...
export async function GET(req:Request) {
    ...
    try{
        ...
        const response = await axios.get(`https://api.rule34.xxx/index.php?page=dapi&s=post&q=index&tags=${search}&limit=25&pid=${page}&json=1&api_key=321207195b473b6ba36d87bd625e9eb93995b2fc8f04d8ef326bbb7512a6a06592ee97b59a0d932abff053ed19ad9a486a9ea56c77caca3ffc2d74ea1cc82342&user_id=4475901`)
